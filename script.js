...
form.addEventListener("submit", (e) => {
  ...
  if (passwordConfirm.value !== passwordInput.value) {
    errorMessages.push("You have entered an incorrect password!");
  }
  //      4. Ensure the terms checkbox is checked
  if (!termsInput.checked) {
    errorMessages.push("You must agree to terms of use!");
  }
...
function clearErrors() {
  ...
  // this line would solve problem or use while loop to practice
